...
func newConfigCut() *CutConfig {
	cfg := CutConfig{}
	flag.StringVar(&cfg.fields, "-f", "", "List of fields to cut")
	flag.StringVar(&cfg.delimiter, "-d", "\t", "Sets custom delimeter")
	flag.BoolVar(&cfg.separated, "s", false, "do not print lines not containing delimiters")
	flag.Parse()
	return &cfg
}
